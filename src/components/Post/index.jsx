...
function Post() {
    ...
    const imageBed = "https://assets.myntassets.com/f_webp,dpr_1.5,q_auto:eco,w_400,c_limit,fl_progressive/assets/images/2022/12/15/2f98dc81-f574-40d9-989f-d4f549cc48291671116151641-47.jpg"
    ...
    return (
        <div className="post">
            ...
            <div className="postImage">
                <img src={imageBed} alt="postImage" />
            </div>
